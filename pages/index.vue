        ...
        <div class="service-market-left">
          ...
          <el-row class="row">
            <el-col :span="8" class="col">
              <a class="col-fl" @click>生活常用</a>
            </el-col>
            <el-col :span="8" class="col">
              <a class="col-fl" @click>天气预报</a>
            </el-col>
            <el-col :span="8" class="col">
              <a class="col-fl" @click>条码查询</a>
            </el-col>
            <el-col :span="8" class="col">
              <a class="col-fl" @click>即时通讯</a>
            </el-col>
            <el-col :span="8" class="col">
              <a class="col-fl" @click>短信服务</a>
            </el-col>
            <el-col :span="8" class="col">
              <a class="col-fl" @click>语音服务</a>
            </el-col>
            <el-col :span="8" class="col">
              <a class="col-fl" @click>充值缴费</a>
            </el-col>
            <el-col :span="8" class="col">
              <a class="col-fl" @click>加油卡充值</a>
            </el-col>
            <el-col :span="8" class="col">
              <a class="col-fl" @click>话费流量</a>
            </el-col>
            <el-col :span="8" class="col">
              <a class="col-fl" @click>开发服务</a>
            </el-col>
            <el-col :span="8" class="col">
              <a class="col-fl" @click>内容管理</a>
            </el-col>
            <el-col :span="8" class="col">
              <a class="col-fl" @click>广告管家</a>
            </el-col>
            <el-col :span="8" class="col">
              <a class="col-fl" @click>医疗健康</a>
            </el-col>
            <el-col :span="8" class="col">
              <a class="col-fl" @click>常见疾病</a>
            </el-col>
            <el-col :span="8" class="col">
              <a class="col-fl" @click>生活常用</a>
            </el-col>
            <el-col :span="8" class="col">
              <a class="col-fl" @click>金融征信</a>
            </el-col>
            <el-col :span="8" class="col">
              <a class="col-fl" @click>企业开票信息</a>
            </el-col>
            <el-col :span="8" class="col">
              <a class="col-fl" @click>生活常用</a>
            </el-col>
            <el-col :span="8" class="col">
              <a class="col-fl" @click>电商购物</a>
            </el-col>
            <el-col :span="8" class="col">
              <a class="col-fl" @click>生活常用</a>
            </el-col>
            ...
            <el-col :span="8" class="col">
              <a class="col-fl" @click>基础数据</a>
            </el-col>
            <el-col :span="8" class="col">
              <a class="col-fl" @click>省市区数据</a>
            </el-col>
            <el-col :span="8" class="col">
              <a class="col-fl" @click>生活常用</a>
            </el-col>
...
export default {
  ...
  methods: {
    ...
    getArticleList: function() {
      axios
        .get(
          `https://api2.easyapi.com/api/articles?appKey=ja4fkcz35kfqywi7&appSecret=k1v8c637vr4swgr8&size=7`
        )
        .then(res => {
          this.list =
            this.list.length > 0
